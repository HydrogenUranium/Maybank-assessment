  ...
  private QueryBuilder builder;
    ...
    private Page getGroupPage(Page self) {
		...
		if (parentProperties != null) {
			if (
				("dhl/components/pages/home").equals(parentProperties.get("jcr:content/sling:resourceType", "")) ||
				("dhl/components/pages/articlecategory").equals(parentProperties.get("jcr:content/sling:resourceType", ""))
			) {
				return self;
			}
