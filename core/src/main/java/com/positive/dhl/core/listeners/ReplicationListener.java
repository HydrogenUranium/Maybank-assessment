	...
	public void handleEvent(Event event) {
		if(akamaiFlushConfigReader.isEnabled()){
			...
			if (null != replicationAction && isInScope(replicationAction)) {
				...
				AkamaiInvalidationResult result = akamaiFlush.invalidateAkamaiCache(replicationAction.getPath(), StringUtils.EMPTY);
				log.info(RESULT_OF_FLUSH_REQUEST, result, replicationPagePath);
