...
@Component(
	...
	property = {
			Constants.SERVICE_DESCRIPTION + "=DHL Check Login Servlet",
			"sling.servlet.methods=" + HttpConstants.METHOD_POST,
			"sling.servlet.paths="+ "/apps/dhl/discoverdhlapi/check/index.json"
	}
)
public class CheckServlet extends SlingAllMethodsServlet {
