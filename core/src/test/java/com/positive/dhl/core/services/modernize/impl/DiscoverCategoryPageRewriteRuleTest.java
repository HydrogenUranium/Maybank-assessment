...
class DiscoverCategoryPageRewriteRuleTest {
    ...
    DiscoverCategoryPageRewriteRule rule = new DiscoverCategoryPageRewriteRule();

    @BeforeEach
    public void beforeEach() {
        context.load().json("/com/positive/dhl/core/services/modernize/impl/DiscoverCategoryPageRewriteRule/page-content.json", "/content/test");
        context.load().json("/com/positive/dhl/core/services/modernize/impl/DiscoverCategoryPageRewriteRule/conf-template.json", "/conf/dhl/settings/wcm/templates/category-page");

        Map<String, Object> props = Map.of(
                "id", "category",
                "editableTemplate", "/conf/dhl/settings/wcm/templates/category-page",
                "staticTemplate", "/apps/dhl/templates/dhl-article-group-page",
                "containerMappings", new String[]{"parcarousel:root/responsivegrid"},
