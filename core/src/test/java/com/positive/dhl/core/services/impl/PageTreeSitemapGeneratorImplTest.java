...
import static com.positive.dhl.core.services.impl.PageTreeSitemapGeneratorImpl.HTML_EXTENSION;
...
public class PageTreeSitemapGeneratorImplTest {
    ...
    public static final String TEST_RESOURCE_PATH = "/com/positive/dhl/core/services/impl/PageTreeSitemapGeneratorImplTest/page_resource.json";
