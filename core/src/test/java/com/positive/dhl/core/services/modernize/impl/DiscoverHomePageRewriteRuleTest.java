...
class DiscoverHomePageRewriteRuleTest {
    ...
    DiscoverHomePageRewriteRule rule = new DiscoverHomePageRewriteRule();

    @BeforeEach
    public void beforeEach() {
        context.load().json("/com/positive/dhl/core/services/modernize/impl/DiscoverHomePageRewriteRuleTest/page-content.json", "/content/test");
        context.load().json("/com/positive/dhl/core/services/modernize/impl/DiscoverHomePageRewriteRuleTest/conf-template.json", "/conf/dhl/settings/wcm/templates/home-page");
