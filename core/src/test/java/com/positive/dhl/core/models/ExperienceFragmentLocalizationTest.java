...
class ExperienceFragmentLocalizationTest {
    ...
    void init() {
        ...
        context.load().json("/com/positive/dhl/core/models/ExperienceFragmentLocalization/page.json", "/content/dhl/global");
        context.load().json("/com/positive/dhl/core/models/ExperienceFragmentLocalization/fragments.json", "/content/experience-fragments/dhl");
