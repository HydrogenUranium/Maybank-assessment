 ...
 */
package com.deutschepostagdiscover.core.models;
...
import com.deutschepostagdiscover.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "deutschepostagdiscover/components/helloworld");
