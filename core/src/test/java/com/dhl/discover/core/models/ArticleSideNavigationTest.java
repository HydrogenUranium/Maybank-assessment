...
class ArticleSideNavigationTest {
    ...
    void setUp() throws Exception {
        ...
        ctx.load().json("/com/dhl/discover/core/models/articlesidenav.json", PAGE_PATH);
        ctx.load().json("/com/dhl/discover/core/models/effective-enterpreneurs.json", ARTICLE_PATH);
