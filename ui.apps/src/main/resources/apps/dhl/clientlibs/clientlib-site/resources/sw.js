const cacheName = 'discoverDhl-${project.version}-${serviceWorkerTimestamp}';

//Assets to cache
const assetsToCache = [
	'/discover/etc/designs/dhl/clientlib-site.css',
	'/discover/etc/designs/dhl/clientlib-site.js',
