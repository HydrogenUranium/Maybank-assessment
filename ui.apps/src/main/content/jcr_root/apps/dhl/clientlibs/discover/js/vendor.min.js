...
(function ($) {
  ...
  $.fn.waterwheelCarousel = function (startingOptions) {
    ...
    function performCalculations($item, newPosition) {
      ...
      console.log(options.sizeMultiplier, newDistanceFromCenter, Math.pow(options.sizeMultiplier, newDistanceFromCenter));
      ...
      // console.log($item, newPosition, newDistance, widthDifference, distanceFactor, newLeft);
    }
    ...
    $(this).children().bind("click", function () {
      ...
      console.log('Rotations: ' + itemPosition);
      if (itemPosition == 0) {
