...
var MarketForm = function () {
  ...
  _createClass(MarketForm, [{
    ...
    value: function bindEvents(elem) {
      ...
      var hiddenFormId = $elem.attr('hiddenformid');
      var hiddenMunchkinId = $elem.attr('hiddenmunchkinid');
      var hiddenSettings = true;
      if (typeof hiddenFormId === 'undefined' || typeof hiddenMunchkinId === 'undefined') {
