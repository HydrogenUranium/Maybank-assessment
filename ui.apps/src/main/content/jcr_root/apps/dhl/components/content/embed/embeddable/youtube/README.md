...
-->
YouTube With Schema Markup Embeddable (Custom Component)
====
YouTube component written in HTL that includes the YouTube player via an iFrame. It is used from the [Embed component](../..).
YouTube With Schema Markup is a copy of YouTube component. Since each embeddable component
should have sling:resourceSuperType="core/wcm/components/embed/v1/embed/embeddable" there is no way to use
YouTube as supertype.
