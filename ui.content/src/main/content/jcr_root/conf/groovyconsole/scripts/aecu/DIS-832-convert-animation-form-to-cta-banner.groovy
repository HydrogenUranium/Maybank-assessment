/* DIS-832 Convert Animated Form component to CTA Banner With Points components ('Open A Business Account' )
Steps:
0)  INITIAL SETUP
...
def getAffectedItemPaths() {
    ...
    if (affectedItemPaths.size() == 0) {
        getPage(contentScope).recurse { page ->
            ...
            if (content && page.path ==~ /^\/content\/dhl\/(language-masters|global|\w{2})(\/.*)?/) {
...
def manipulations(affectedItemPaths) {
    ...
    affectedItemPaths.each { itemPath ->
        ...
        aecu.contentUpgradeBuilder()
                ...
                .doSetProperty("tabletBackgroundImage", tabletBackgroundImageValue)
                .doSetProperty("mobileBackgroundImage", mobileBackgroundImageValue)
                .doDeleteProperty("description")
                .doDeleteProperty("linkText")
                .doDeleteProperty("formTitle")
                .doDeleteProperty("firstNamePlaceholder")
                .doDeleteProperty("firstNameMessage")
                .doDeleteProperty("lastNamePlaceholder")
                .doDeleteProperty("lastNameMessage")
                .doDeleteProperty("emailPlaceholder")
                .doDeleteProperty("emailMessage")
                .doDeleteProperty("companyNamePlaceholder")
                .doDeleteProperty("companyNameMessage")
                .doDeleteProperty("phoneNumberPlaceholder")
                .doDeleteProperty("phoneNumberMessage")
                .doDeleteProperty("addressPlaceholder")
                .doDeleteProperty("addressMessage")
                .doDeleteProperty("zipOrPostcodePlaceholder")
                .doDeleteProperty("zipOrPostcodeMessage")
                .doDeleteProperty("cityPlaceholder")
                .doDeleteProperty("cityMessage")
                .doDeleteProperty("countryPlaceholder")
                .doDeleteProperty("countryMessage")
                .doDeleteProperty("nextButtonTitle")
                .doDeleteProperty("applyNowTitle")
                .run(dryRun)
    }
}
