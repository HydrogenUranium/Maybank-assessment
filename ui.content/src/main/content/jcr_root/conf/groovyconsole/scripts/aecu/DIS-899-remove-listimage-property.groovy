/* DIS-899 Removing 'Listimage' properties
Steps:
0)  INITIAL SETUP
...
@Field versionAndPackageName = "DIS-899-before-removing-listimage"
...
def manipulations(affectedItemPaths) {
    ...
    affectedItemPaths.each { itemPath ->
        ...
        def featuredImage = getResource(itemPath + "/cq:featuredimage") ? getNode(itemPath + "/cq:featuredimage").get("fileReference") : ""
        if (!featuredImage) {
