...
@Field SUBSCRIPTION_KEY = "<subscription-key>" // Replace with your Azure Translator subscription key
@Field REGION = "<cluster-region>" // Replace with your Azure Translator resource region, e.g., "westus2"
