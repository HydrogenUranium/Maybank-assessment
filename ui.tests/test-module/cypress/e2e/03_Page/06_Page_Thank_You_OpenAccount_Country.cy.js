    ...
    viewports.forEach((viewport, vIndex) => {
      context(`Testing on ${viewport}`, () => {
        ...
        it('Test case', () => {
          ...
          cy.wait(2000);
          cy.get('.followUs__items > [href="https://www.youtube.com/@DHLExpressSG"]').should('have.attr', 'href');
          cy.wait(2000);
          cy.get('.followUs__items > [href="https://www.instagram.com/discoverbydhl/"]').should('have.attr', 'href');
          cy.wait(2000);
          cy.get('.followUs__items > [href="https://www.linkedin.com/company/dhl-express-singapore/"]').should('have.attr', 'href');
          cy.wait(2000);
