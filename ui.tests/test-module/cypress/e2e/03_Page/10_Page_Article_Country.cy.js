describe('Singapore Page Article Country', () => {
  ...
  const selectors = {
    ...
    shareContainer: '.article-header > .article-header_share > .article-header_share-container',
    heroBanner: '.hero-banner-component > .hero-banner',
    heroBannerSummary: '.summary__label',
    ...
    gallery: '.gallery',
    gallerySlides: ['#uniqueIdImageGallerySlide0 > .figure', '#uniqueIdImageGallerySlide1 > .figure'],
    tabs: '.tabs',
    tabItem: '[id*="-tab"]',
