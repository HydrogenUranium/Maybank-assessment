    ...
    viewports.forEach((viewport, vIndex) => {
      context(`Testing on ${viewport}`, () => {
        ...
        it('All test cases', function () {
          ...
          cy.get('.cta-banner-with-points:not(.headerV2) .cmp-cta-banner-with-points__body').should('exist');
          cy.get('.cta-banner-with-points:not(.headerV2) .cmp-cta-banner-with-points__button').click();
