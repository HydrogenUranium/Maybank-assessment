describe('DHL Landing Page - Two Column', () => {
  const pageUrl = Cypress.env('AEM_PUBLISH_URL') + '/content/dhl/global/en-global/automation-testing/dhl-landing-two-column-page.html'
  ...
  viewports.forEach(viewport => {
    context(`Testing on ${viewport}`, () => {
      ...
      it('1.Verify hero banner is exist with image', function() {
      ...
      it('3.Verify landing page point is exist with title, icon and content', function() {
        cy.get('.landing-points-component').should('exist');
      });

      it('4.Verify marketo form is exist', function() {
        cy.get('.marketoForm__container').should('exist');
      });

      it('5.Verify if all fields are present', () => {
      ...
      it('6.Verify the form submits successfully when all fields are filled out correctly.', () => {
      ...
      it('7. Verify header and footer exist', function() {
